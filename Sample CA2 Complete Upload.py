...
class Temperature:
    ...
    @ staticmethod
    def Temp_as_Cels(Celsius_in):           # Takes in Celsius value and...
        return (9/5) * (Celsius_in + 32)    # Returns Fahrenheit

    @ staticmethod
    def Temp_as_Fahr(Fahrenheit_in):            # Takes in Fahrenheit value and...
        return (5/9) * (Fahrenheit_in - 32)     # Returns Celsius
